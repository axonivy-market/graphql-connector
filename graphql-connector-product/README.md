...
This Connector provides a GraphQL endpoint running with the Ivy Engine.
...
The GraphQL Resource `com.axonivy.connector.graphql.resource.GraphQLResource` is automatically detected and published by the Ivy Engine.
